...
namespace lidar_localization
{
    ...
    ICPRegistration::ICPRegistration(
        const YAML::Node &node) : icp_ptr_(new pcl::IterativeClosestPoint<CloudData::POINT, CloudData::POINT>())
    {
    ...
    ICPRegistration::ICPRegistration(
        ...
        int max_iter) : icp_ptr_(new pcl::IterativeClosestPoint<CloudData::POINT, CloudData::POINT>())
    {
                                    ...
                                    Eigen::Matrix4f &result_pose)
    {
        ...
        icp_ptr_->align(*result_cloud_ptr, predict_pose); // align with initial guess
