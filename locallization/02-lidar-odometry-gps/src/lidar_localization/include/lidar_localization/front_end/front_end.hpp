...
namespace lidar_localization
{
  ...
  public:
    ...
    bool InitWithConfig();
    bool UpdatewithGPSxy(const CloudData &cloud_data, Eigen::Matrix4f &cloud_pose, Eigen::Matrix4f &gps_pose);
    bool UpdatewithGPS(const CloudData &cloud_data, Eigen::Matrix4f &cloud_pose, Eigen::Matrix4f &gps_pose);
