...
#include <vector_map_msgs/WaterAreaArray.h>
...
namespace vector_map
{
  ...
  using vector_map_msgs::WaterArea;
  ...
  using vector_map_msgs::WaterAreaArray;
  ...
  private:
    ...
    Handle<WaterArea, WaterAreaArray> water_area_;
  ...
  public:
    ...
    WaterArea findByKey(const Key<WaterArea> &key) const;
    ...
    std::vector<WaterArea> findByFilter(const Filter<WaterArea> &filter) const;
    ...
    void registerCallback(const Callback<WaterAreaArray> &cb);
  };
