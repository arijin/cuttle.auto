...
static bool getVelodynePose(
    const tf::TransformListener& tf_buffer,
    const std::string& source_frame,  // local_frame_id_
    const std::string& target_frame,  // global_frame_id_
