...
namespace object_map
{
  ...
  /*!
	 ...
	 */
  std::vector<geometry_msgs::Point> SearchAreaPoints(const vector_map::Area &in_area, const vector_map::VectorMap &in_vectormap);
  std::vector<geometry_msgs::Point> SearchLinePoints(const vector_map::Line &in_line, const vector_map::VectorMap &in_vectormap, const int end_id);
  /*!
  ...
  void FillPolygonAreas(grid_map::GridMap &out_grid_map,
                        ...
                        const tf::TransformListener &in_tf_listener);
  void FillPolygonRiverAreas(grid_map::GridMap &out_grid_map,
                             const std::vector<std::vector<geometry_msgs::Point>> &in_area_points,
