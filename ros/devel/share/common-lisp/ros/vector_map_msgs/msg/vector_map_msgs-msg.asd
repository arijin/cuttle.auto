...
(defsystem "vector_map_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "WaterArea" :depends-on ("_package_WaterArea"))
    (:file "_package_WaterArea" :depends-on ("_package"))
    (:file "WaterAreaArray" :depends-on ("_package_WaterAreaArray"))
    (:file "_package_WaterAreaArray" :depends-on ("_package"))
