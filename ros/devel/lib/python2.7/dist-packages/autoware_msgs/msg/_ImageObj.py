...
"""autogenerated by genpy from autoware_msgs/ImageObj.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','autoware_msgs/ImageRect[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = autoware_msgs.msg.ImageRect()
        _x = val1
        start = end
        end += 20
