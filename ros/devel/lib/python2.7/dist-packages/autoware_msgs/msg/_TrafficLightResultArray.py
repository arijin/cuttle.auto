...
"""autogenerated by genpy from autoware_msgs/TrafficLightResultArray.msg. Do not edit."""
import sys
...
class TrafficLightResultArray(genpy.Message):
  ...
  _type = "autoware_msgs/TrafficLightResultArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','autoware_msgs/TrafficLightResult[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = autoware_msgs.msg.TrafficLightResult()
        _v3 = val1.header
        start = end
        end += 4
