...
"""autogenerated by genpy from autoware_msgs/GridMapInfo.msg. Do not edit."""
import sys
...
class GridMapInfo(genpy.Message):
  _md5sum = "ffedeb0db1855084acbee985977e827c"
  _type = "autoware_msgs/GridMapInfo"
...
float64 y
float64 z"""
  __slots__ = ['header','map','trans']
  _slot_types = ['std_msgs/Header','grid_map_msgs/GridMap','geometry_msgs/Transform']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2H7d().pack(_x.map.outer_start_index, _x.map.inner_start_index, _x.trans.translation.x, _x.trans.translation.y, _x.trans.translation.z, _x.trans.rotation.x, _x.trans.rotation.y, _x.trans.rotation.z, _x.trans.rotation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.map.outer_start_index, _x.map.inner_start_index, _x.trans.translation.x, _x.trans.translation.y, _x.trans.translation.z, _x.trans.rotation.x, _x.trans.rotation.y, _x.trans.rotation.z, _x.trans.rotation.w,) = _get_struct_2H7d().unpack(str[start:end])
      return self
...
def _get_struct_10d():
    ...
    return _struct_10d
_struct_2H7d = None
def _get_struct_2H7d():
    global _struct_2H7d
    if _struct_2H7d is None:
        _struct_2H7d = struct.Struct("<2H7d")
    return _struct_2H7d
