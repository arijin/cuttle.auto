...
"""
  ...
  _slot_types = ['std_msgs/Header','autoware_msgs/SteerCmd','autoware_msgs/AccelCmd','autoware_msgs/BrakeCmd','autoware_msgs/LampCmd','int32','int32','geometry_msgs/TwistStamped','autoware_msgs/ControlCommand','int32']
