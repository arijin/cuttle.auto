...
"""autogenerated by genpy from autoware_msgs/ScanImage.msg. Do not edit."""
import sys
...
class ScanImage(genpy.Message):
  _md5sum = "d3276ec225af95b58af799f4633b1f5d"
  _type = "autoware_msgs/ScanImage"
...
string frame_id
"""
  __slots__ = ['header','distance','intensity','max_y','min_y']
  _slot_types = ['std_msgs/Header','float32[]','float32[]','int32','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,distance,intensity,max_y,min_y
    ...
    """
    if args or kwds:
      super(ScanImage, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2i().pack(_x.max_y, _x.min_y))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.max_y, _x.min_y,) = _get_struct_2i().unpack(str[start:end])
      return self
