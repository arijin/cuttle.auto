...
"""autogenerated by genpy from autosense_msgs/TrackingObjectArray.msg. Do not edit."""
import sys
...
class TrackingObjectArray(genpy.Message):
  _md5sum = "58293c548ad89b5f0072e8120a1fdc02"
  _type = "autosense_msgs/TrackingObjectArray"
...
float64 z
"""
  __slots__ = ['header','ids','segments','sizes','positions','directions','velocities']
  _slot_types = ['std_msgs/Header','uint32[]','sensor_msgs/PointCloud2[]','geometry_msgs/Point[]','geometry_msgs/Point[]','geometry_msgs/Point[]','geometry_msgs/Point[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,ids,segments,sizes,positions,directions,velocities
