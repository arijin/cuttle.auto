...
"""autogenerated by genpy from vector_map_msgs/BoxArray.msg. Do not edit."""
import sys
...
class BoxArray(genpy.Message):
  _md5sum = "4cd97936398de3e376fdd81cf2cabcee"
  _type = "vector_map_msgs/BoxArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','vector_map_msgs/Box[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BoxArray, self).__init__(*args, **kwds)
